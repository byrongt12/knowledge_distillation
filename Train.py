...
def train_model_with_distillation(epochs, train_dl, test_dl, student_model, student_model_number, teacher_model,
                                  ...
                                  weight_decay, scheduler, heuristicToStudentDict, kd_loss_type, distill_optimizer_name, distill_lr,
                                  grad_clip=None):
    torch.cuda.empty_cache()
    history = []
    ...
    for epoch in range(epochs):
        ...
        for batch in train_dl:
            ...
            distill(heuristicString, index, heuristicToStudentDict, device, teacher_model,
                                  ...
                                  student_model, student_model_number, batch, kd_loss_type, distill_optimizer_name, distill_lr)
